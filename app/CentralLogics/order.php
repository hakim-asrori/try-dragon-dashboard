...
use App\Models\{AccountTransaction, Admin, AdminWallet, BusinessSetting, DeliveryMan, DeliveryManWallet, Incentive, IncentiveLog, Order, OrderPayment, OrderTransaction, Restaurant, RestaurantWallet, Subscription, SubscriptionLog, User, Vendor};
        ...
        try {
            ...
            try {
                ...
                if ($received_by == 'admin') {
                    ...
                    $dmWallet->total_earning = $dmWallet->total_earning - ($order->order_amount - $order->partially_paid_amount);
                }
                if (isset($dmWallet)) {
                    $dmWallet->save();
                }
