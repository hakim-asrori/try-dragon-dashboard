...
use App\Models\{BusinessSetting, Cart, EmailVerifications, Guest, User, WalletTransaction};
...
class CustomerAuthController extends Controller
{
    ...
    public function register(Request $request)
    {
        ...
        try {
            ...
            DB::rollBack();
            return response()->json(['errors' => Helpers::error_formater($th->getCode(), $th->getMessage())], 500);
        }
    }
